// Code generated by the Encore v1.21.0 client generator. DO NOT EDIT.
...
// Client is an API client for the helloworld-5w4i Encore application.
type Client struct {
	About   AboutClient
	Member  MemberClient
...
func Environment(name string) BaseURL {
	return BaseURL(fmt.Sprintf("https://%s-helloworld-5w4i.encr.app", name))
}
...
func New(target BaseURL, options ...Option) (*Client, error) {
	...
	base := &baseClient{
		...
		userAgent:  "helloworld-5w4i-Generated-Go-Client (Encore/v1.21.0)",
	}
	...
	return &Client{
		About:   &aboutClient{base},
		Member:  &memberClient{base},
		Product: &productClient{base},
	}, nil
}
...
type AboutLocationListResponse struct {
	Locations []AboutLocationStruct `json:"locations"`
}

// LocationStruct is a struct containing information about a location
type AboutLocationStruct struct {
	Name    string `json:"name"`
	Comment string `json:"comment"`
	Address string `json:"address"`
}

// AboutClient Provides you access to call public and authenticated APIs on about. The concrete implementation is aboutClient.
...
type AboutClient interface {
	...
	Locations(ctx context.Context) (AboutLocationListResponse, error)
}
...
var _ AboutClient = (*aboutClient)(nil)

// Endpoint to get information about the locations of the company
func (c *aboutClient) Locations(ctx context.Context) (resp AboutLocationListResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", "/about/locations", nil, nil, &resp)
	if err != nil {
		return
	}
...
type MemberListResponse struct {
	Members []MemberMemberStruct `json:"members"`
}

type MemberMemberStruct struct {
	Name     string `json:"name"`
...
type MemberSingleResponse struct {
	Member MemberMemberStruct `json:"member"`
}

// MemberClient Provides you access to call public and authenticated APIs on member. The concrete implementation is memberClient.
// It is setup as an interface allowing you to use GoMock to create mock implementations during tests.
type MemberClient interface {
	// Returns a member
	Member(ctx context.Context, name string) (MemberSingleResponse, error)

	// Returns all members sorted by name
	Members(ctx context.Context) (MemberListResponse, error)
}
...
var _ MemberClient = (*memberClient)(nil)

// Returns a member
func (c *memberClient) Member(ctx context.Context, name string) (resp MemberSingleResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/member/%s", url.PathEscape(name)), nil, nil, &resp)
	if err != nil {
		return
	}
...
// Returns all members sorted by name
func (c *memberClient) Members(ctx context.Context) (resp MemberListResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", "/members", nil, nil, &resp)
	if err != nil {
		return
	}
...
type ProductTrainingListResponse struct {
	Trainings []ProductTrainingStruct `json:"trainings"`
}

type ProductTrainingStruct struct {
	Name        string `json:"name"`
...
// ProductClient Provides you access to call public and authenticated APIs on product. The concrete implementation is productClient.
// It is setup as an interface allowing you to use GoMock to create mock implementations during tests.
type ProductClient interface {
	// Returns a training
	Training(ctx context.Context, name string) (ProductTrainingListResponse, error)

	// Returns all trainings sorted by name
	Trainings(ctx context.Context) (ProductTrainingListResponse, error)
}
...
var _ ProductClient = (*productClient)(nil)

// Returns a training
func (c *productClient) Training(ctx context.Context, name string) (resp ProductTrainingListResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/product/training/%s", url.PathEscape(name)), nil, nil, &resp)
	if err != nil {
		return
	}
...
// Returns all trainings sorted by name
func (c *productClient) Trainings(ctx context.Context) (resp ProductTrainingListResponse, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", "/product/trainings", nil, nil, &resp)
	if err != nil {
		return
	}
